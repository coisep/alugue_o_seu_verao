...
const Home = () => {
    ...
    return (
        ...
        <Layout pageName={"Home"}>
            ...
            <div style={{ height: "300px", width: "70%", position: "relative", zIndex: 1, margin: "250px auto 0" }}>
                {/* <Carrosel height={550} images={carouselImagens} /> */}
                <video autoPlay loop muted  style={{ borderRadius: "36px", boxShadow: "0px 0px 30px rgba(0, 0, 0, 0.2)"}}
>
                    <source src="/Images/Video_de_retrospectiva.mp4" type="video/mp4" />
            ...
            <div style={{ position: "relative", zIndex: 5, boxShadow: "30px"}}>
            ...
            <div style={{ position: "relative" }}>
                <div style={{ position: "fixed", top: "98%", right: "1rem", transform: "translateY(-40%)" }}>
                    <a className="float-button" target="_blank" href="https://api.whatsapp.com/send?phone=351919063304&text=Ola!%20">
